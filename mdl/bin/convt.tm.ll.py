...
m_arLonCenter = [0.0, 2.22529479629277, 2.216568150032944]
m_arLatCenter = [0.0, 0.663225115757845, 0.663225115757889]
...
if __name__ == "__main__" :
    if not len(sys.argv) == 4 :
         print '  Usage: python convt.tm.ll.py [1 or 2] [x] [y]'
         print '  arg1 is 1 : LonLat to TM, (Ex) python convt.tm.ll.py 1    129.123123     35.897780'
         print '  arg1 is 2 : TM to LonLat, (Ex) python convt.tm.ll.py 2 391619.367623 268478.982738'
         exit(1)

    pt = GeoPoint(float(sys.argv[2]),float(sys.argv[3]))
    if int(sys.argv[1]) == 1 :
         output = convert(GEO,TM,pt)
