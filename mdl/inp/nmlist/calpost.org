CALPUFF Application with met data from CALMET
Produce table and map-file for peak 1-hr average concentrations
...
--------------
     ...
     Starting date:    Year   (ISYR)  --    No default   ! ISYR  =  2018  !
                       Month  (ISMO)  --    No default   ! ISMO  =  06  !
                       Day    (ISDY)  --    No default   ! ISDY  =  20  !
     Starting time:    Hour   (ISHR)  --    No default   ! ISHR  =  00  !
